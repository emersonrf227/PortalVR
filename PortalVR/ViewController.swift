...
class ViewController: UIViewController {
    ...
    func updatePlaneNode(_ node: SCNNode, center: vector_float3, extent: vector_float3){
        ...
        geometry?.height = CGFloat(extent.x)
    ...
    func makeFloorNode() -> SCNNode {
        ...
        innerFloor.firstMaterial?.diffuse.contents = UIImage(named: "Portal.scnassets/floor/textures/Floor_Diffuse.png")
        innerFloor.firstMaterial?.normal.contents = UIImage(named: "Portal.scnassets/floor/textures/Floor_Normal.png")
        innerFloor.firstMaterial?.roughness.contents = UIImage(named: "Portal.scnassets/floor/textures/Floor_Roughness.png")
        innerFloor.firstMaterial?.specular.contents = UIImage(named: "Portal.scnassets/floor/textures/Floor_Specular.png")
        innerFloor.firstMaterial?.selfIllumination.contents =  UIImage(named: "Portal.scnassets/floor/textures/Floor_Gloss.png")
    ...
    func makeCeilingNode() -> SCNNode {
        ...
        innerCeiling.firstMaterial?.diffuse.contents = UIImage(named: "Portal.scnassets/ceiling/textures/Ceiling_Diffuse.png")
        innerCeiling.firstMaterial?.emission.contents = UIImage(named: "Portal.scnassets/ceiling/textures/Ceiling_Emis.png")
        innerCeiling.firstMaterial?.normal.contents = UIImage(named: "Portal.scnassets/ceiling/textures/Ceiling_Normal.png")
        innerCeiling.firstMaterial?.specular.contents = UIImage(named: "Portal.scnassets/ceiling/textures/Ceiling_Specular.png")
        innerCeiling.firstMaterial?.selfIllumination.contents = UIImage(named: "Portal.scnassets/ceiling/textures/Ceiling_Gloss.png")
    ...
    func makeWallNode(length: CGFloat = 3.0, height: CGFloat = 3.0, maskLowerSide:Bool = false) -> SCNNode {
        ...
        innerWall.firstMaterial?.diffuse.contents = UIImage(named: "Portal.scnassets/wall/textures/Walls_Diffuse.png")
        innerWall.firstMaterial?.metalness.contents = UIImage(named: "Portal.scnassets/wall/textures/Walls_Metalness.png")
        innerWall.firstMaterial?.roughness.contents = UIImage(named: "Portal.scnassets/wall/textures/Walls_Roughness.png")
        innerWall.firstMaterial?.normal.contents = UIImage(named: "Portal.scnassets/wall/textures/Walls_Normal.png")
        innerWall.firstMaterial?.specular.contents = UIImage(named: "Portal.scnassets/wall/textures/Walls_Spec.png")
        innerWall.firstMaterial?.selfIllumination.contents = UIImage(named: "Portal.scnassets/wall/textures/Walls_Gloss.png")
...
extension ViewController: ARSCNViewDelegate {
    ...
    func renderer(_ renderer: SCNSceneRenderer, didAdd node: SCNNode, for anchor: ARAnchor) {
        if let planeAnchor = anchor as? ARPlaneAnchor, !isPortalPlaced{
            ...
            let debugPlane = createPlaneNode(center: planeAnchor.center, extent: planeAnchor.center)
